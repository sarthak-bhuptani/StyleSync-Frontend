...
export const ProfilePage = () => {
  ...
  const [activeTab, setActiveTab] = useState('colors'); // 'grid' | 'colors' | 'sizes' | 'brands'
      ...
      <div className="bg-white rounded-3xl border border-slate-200/70 p-4 sm:p-5 shadow-xs space-y-3.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="relative shrink-0 w-16 h-16 sm:w-20 sm:h-20">
            <div className="w-16 h-16 sm:w-20 sm:h-20 p-[2.5px] rounded-full bg-gradient-to-tr from-amber-500 via-rose-500 to-purple-600 shadow-xs flex items-center justify-center overflow-hidden shrink-0">
              <img
            ...
            <button
              ...
              className="absolute -bottom-0.5 -right-0.5 p-1.5 bg-slate-900 hover:bg-slate-800 text-white rounded-full border-2 border-white shadow-sm cursor-pointer transition-transform hover:scale-105 active:scale-95 z-10"
              title="Update photo"
            >
        ...
        <div className="flex items-center gap-2 pt-1">
          ...
          <NavLink
            to="/settings"
            className="p-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl transition-colors flex items-center justify-center"
            title="Settings"
          >
